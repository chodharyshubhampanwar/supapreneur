  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center px-5 py-2 bg-primary-color text-white font-semibold rounded shadow disabled:opacity-70 disabled:cursor-not-allowed w-full"
      >
        {loading ? (
